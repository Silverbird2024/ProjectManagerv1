...
$scope.Headline24_click = function() {$scope.GotoPage( "H1Main" );};
...
$scope.Headline87_click = function() {$scope.GotoPage( "H1Main" );};
...
$scope.Headline230_click = function() {$scope.GotoPage( "H1Main" );};
...
$scope.Headline194_click = function() {$scope.GotoPage( "H1Main" );};
...
$scope.Headline232_click = function() {$scope.GotoPage( "H1Main" );};
...
$scope.PushButton63_click = function() {$scope.GotoPage( "H1m3" );};
...
$scope.TextArea85_change = function() {localStorage.setItem("h3note1",$App.h3note1);};
$scope.TextArea86_change = function() {localStorage.setItem("h3note2",$App.h3note2);};
});
...
$scope.PushButton65_click = function() {$scope.GotoPage( "H4m3" );};
...
$scope.TextArea87_change = function() {localStorage.setItem("h4note1",$App.h4note1);};
$scope.TextArea88_change = function() {localStorage.setItem("h4note2",$App.h4note2);};
});
