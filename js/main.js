...
localStorage.setItem("L1",$App.L1);
localStorage.setItem("L2",$App.L2);
localStorage.setItem("L3",$App.L3);
localStorage.setItem("L4",$App.L4);
localStorage.setItem("L5",$App.L5);
...
$scope.xxxxxxxxxxxxxxxxxxq_pageenter = function() {$scope.GotoPage( "Home" );};
...
$scope.PushButton78_click = function() {$scope.GotoPage( "Prayer1" );};
...
$scope.Headline300_click = function() {$App.HOverview = $App.h8main;
$scope.MoveObject("H9Box","210","247");
$scope.MoveObject("H10Box","211","314");
$scope.MoveObject("H1Box","211","376");
$scope.MoveObject("H2Box","211","438");
...
$scope.MoveObject("H7Box","10","246");
$scope.MoveObject("H8Box","113","181");};
$scope.Headline300_dblclick = function() {$scope.GotoPage( "H8Main" );};
$scope.Headline301_click = function() {$App.HOverview = $App.h4main;
$scope.MoveObject("H5Box","210","247");
$scope.MoveObject("H6Box","211","314");
$scope.MoveObject("H7Box","211","376");
$scope.MoveObject("H8Box","211","438");
...
$scope.MoveObject("H3Box","10","246");
$scope.MoveObject("H4Box","113","181");};
$scope.Headline301_dblclick = function() {$scope.GotoPage( "H4Main" );};
$scope.Headline302_dblclick = function() {$scope.GotoPage( "H2Main" );};
$scope.Headline304_click = function() {$App.PhOverview = $App.ph1;};
$scope.Headline304_dblclick = function() {$scope.GotoPage( "Ph1Main" );};
$scope.Headline305_click = function() {$App.HOverview = $App.h7main;
$scope.MoveObject("H8Box","210","247");
$scope.MoveObject("H9Box","211","314");
$scope.MoveObject("H10Box","211","376");
$scope.MoveObject("H1Box","211","438");
...
$scope.MoveObject("H6Box","10","246");
$scope.MoveObject("H7Box","113","181");};
$scope.Headline305_dblclick = function() {$scope.GotoPage( "H7Main" );};
$scope.Headline306_click = function() {$App.HOverview = $App.h5main;
$scope.MoveObject("H6Box","210","247");
$scope.MoveObject("H7Box","211","314");
$scope.MoveObject("H8Box","211","376");
$scope.MoveObject("H9Box","211","438");
...
$scope.MoveObject("H4Box","10","246");
$scope.MoveObject("H5Box","113","181");};
$scope.Headline306_dblclick = function() {$scope.GotoPage( "H5Main" );};
...
$scope.Headline309_click = function() {$App.HOverview = $App.h6main;
$scope.MoveObject("H7Box","210","247");
$scope.MoveObject("H8Box","211","314");
$scope.MoveObject("H9Box","211","376");
$scope.MoveObject("H10Box","211","438");
...
$scope.MoveObject("H5Box","10","246");
$scope.MoveObject("H6Box","113","181");};
$scope.Headline309_dblclick = function() {$scope.GotoPage( "H6Main" );};
$scope.Headline310_dblclick = function() {$scope.GotoPage( "H10Main" );};
$scope.Headline311_click = function() {$App.HOverview = $App.h9main;
$scope.MoveObject("H10Box","210","247");
$scope.MoveObject("H1Box","211","314");
$scope.MoveObject("H2Box","211","376");
$scope.MoveObject("H3Box","211","438");
...
$scope.MoveObject("H8Box","10","246");
$scope.MoveObject("H9Box","113","181");};
$scope.Headline311_dblclick = function() {$scope.GotoPage( "H9Main" );};
$scope.Headline312_click = function() {$App.HOverview = $App.h3main;
$scope.MoveObject("H4Box","210","247");
$scope.MoveObject("H5Box","211","314");
$scope.MoveObject("H6Box","211","376");
$scope.MoveObject("H7Box","211","438");
...
$scope.MoveObject("H2Box","10","246");
$scope.MoveObject("H3Box","113","181");};
$scope.Headline312_dblclick = function() {$scope.GotoPage( "H3Main" );};
...
NeoApp.controller("HeadersADHDHelper_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 5;
$App.NAB.PageID = "HeadersADHDHelper";
$scope.TextInput19_change = function() {localStorage.setItem("ad1",$App.ad1);};
$scope.TextInput20_change = function() {localStorage.setItem("ad2",$App.ad2);};
$scope.TextInput21_change = function() {localStorage.setItem("ad3",$App.ad3);};
$scope.TextInput22_change = function() {localStorage.setItem("ad4",$App.ad4);};
$scope.TextInput23_change = function() {localStorage.setItem("ad5",$App.ad5);};
$scope.TextInput24_change = function() {localStorage.setItem("ad6",$App.ad6);};
$scope.TextInput25_change = function() {localStorage.setItem("ad7",$App.ad7);};
$scope.TextInput26_change = function() {localStorage.setItem("ad8",$App.ad8);};
$scope.PushButton17_click = function() {$scope.GotoPage( "Home" );};
$scope.TextInput27_change = function() {localStorage.setItem("ad11",$App.ad11);};
$scope.TextInput28_change = function() {localStorage.setItem("ad12",$App.ad12);};
$scope.TextInput29_change = function() {localStorage.setItem("ad13",$App.ad13);};
$scope.TextInput30_change = function() {localStorage.setItem("ad14",$App.ad14);};
$scope.TextInput31_change = function() {localStorage.setItem("ad15",$App.ad15);};
$scope.TextInput32_change = function() {localStorage.setItem("ad16",$App.ad16);};
$scope.TextInput33_change = function() {localStorage.setItem("ad17",$App.ad17);};
$scope.TextInput34_change = function() {localStorage.setItem("ad18",$App.ad18);};
$scope.TextInput35_change = function() {localStorage.setItem("ad9",$App.ad9);};
$scope.TextInput36_change = function() {localStorage.setItem("ad10",$App.ad10);};
});
...
NeoApp.controller("xxxxxxxxxxxxxxxxxxq_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 19;
$App.NAB.PageID = "xxxxxxxxxxxxxxxxxxq";
});
...
$scope.TextArea91_change = function() {localStorage.setItem("h1main",$App.h1main);};
$scope.TextArea92_change = function() {localStorage.setItem("h1mainCR",$App.h1mainCR);};
$scope.TextArea93_change = function() {localStorage.setItem("h1mainHlight1",$App.h1mainHlight1);};
...
$scope.TextArea1_change = function() {localStorage.setItem("h8main",$App.h8main);};
$scope.TextArea3_change = function() {localStorage.setItem("h8mainCR",$App.h8mainCR);};
$scope.TextArea5_change = function() {localStorage.setItem("h8mainHlight1",$App.h8mainHlight1);};
$scope.Headline18_click = function() {$scope.GotoPage( "H1Main" );};
$scope.PushButton4_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton5_click = function() {$scope.GotoPage( "H8M2" );};
});
...
$scope.TextArea6_change = function() {localStorage.setItem("h8main",$App.h8main);};
$scope.TextArea7_change = function() {localStorage.setItem("h8mainCR",$App.h8mainCR);};
$scope.TextArea8_change = function() {localStorage.setItem("h8mainHlight1",$App.h8mainHlight1);};
$scope.Headline76_click = function() {$scope.GotoPage( "H1Main" );};
$scope.PushButton6_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton11_click = function() {$scope.GotoPage( "H8M2" );};
});
