...
$App.NAB.PageID = "H6M3";
$scope.TextArea55_change = function() {localStorage.setItem("h2note1",$App.h2note1);};
$scope.TextArea56_change = function() {localStorage.setItem("h2note2",$App.h2note2);};
...
$scope.TextArea61_change = function() {localStorage.setItem("h2main",$App.h2main);};
$scope.TextArea62_change = function() {localStorage.setItem("h2mainCR",$App.h2mainCR);};
$scope.TextArea63_change = function() {localStorage.setItem("h2mainHlight1",$App.h2mainHlight1);};
$scope.Headline208_click = function() {$scope.GotoPage( "H1Main" );};
$scope.PushButton38_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton39_click = function() {$scope.GotoPage( "H2m2" );};
});
NeoApp.controller("H7M2_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 32;
$App.NAB.PageID = "H7M2";
$scope.TextArea64_change = function() {localStorage.setItem("h2next",$App.h2next);};
$scope.TextArea73_change = function() {localStorage.setItem("h2due",$App.h2due);};
$scope.Headline215_click = function() {$scope.GotoPage( "H1Main" );};
$scope.PushButton40_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton41_click = function() {$scope.GotoPage( "H2m3" );};
});
NeoApp.controller("H7M3_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 33;
$App.NAB.PageID = "H7M3";
$scope.TextArea74_change = function() {localStorage.setItem("h2note1",$App.h2note1);};
$scope.TextArea75_change = function() {localStorage.setItem("h2note2",$App.h2note2);};
$scope.Headline270_click = function() {$scope.GotoPage( "H1Main" );};
...
$scope.TextArea76_change = function() {localStorage.setItem("h2main",$App.h2main);};
$scope.TextArea77_change = function() {localStorage.setItem("h2mainCR",$App.h2mainCR);};
$scope.TextArea78_change = function() {localStorage.setItem("h2mainHlight1",$App.h2mainHlight1);};
$scope.Headline279_click = function() {$scope.GotoPage( "H1Main" );};
$scope.PushButton63_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton64_click = function() {$scope.GotoPage( "H2m2" );};
});
NeoApp.controller("H8M2_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 36;
$App.NAB.PageID = "H8M2";
$scope.TextArea79_change = function() {localStorage.setItem("h2next",$App.h2next);};
$scope.TextArea80_change = function() {localStorage.setItem("h2due",$App.h2due);};
$scope.Headline286_click = function() {$scope.GotoPage( "H1Main" );};
$scope.PushButton65_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton66_click = function() {$scope.GotoPage( "H2m3" );};
});
NeoApp.controller("H8M3_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 37;
$App.NAB.PageID = "H8M3";
$scope.TextArea84_change = function() {localStorage.setItem("h2note1",$App.h2note1);};
$scope.TextArea85_change = function() {localStorage.setItem("h2note2",$App.h2note2);};
$scope.Headline292_click = function() {$scope.GotoPage( "H1Main" );};
