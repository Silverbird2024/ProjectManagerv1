var NeoApp=angular.module("NeoApp",["ngAnimate","ngRoute","ngSanitize","ngTouch","ui.bootstrap"],function($interpolateProvider){$interpolateProvider.startSymbol("[");$interpolateProvider.endSymbol("]");});NeoApp.config(["$routeProvider",function($routeProvider,$scope,$rootScope){$routeProvider.when("/Home",{templateUrl:"Home",controller:"Home_Ctrl"});$routeProvider.when("/HEADERS",{templateUrl:"HEADERS",controller:"HEADERS_Ctrl"});$routeProvider.when("/Settings1",{templateUrl:"Settings1",controller:"Settings1_Ctrl"});$routeProvider.when("/H1Main",{templateUrl:"H1Main",controller:"H1Main_Ctrl"});$routeProvider.when("/H1m2",{templateUrl:"H1m2",controller:"H1m2_Ctrl"});$routeProvider.when("/HEADER1",{templateUrl:"HEADER1",controller:"HEADER1_Ctrl"});$routeProvider.when("/H1P",{templateUrl:"H1P",controller:"H1P_Ctrl"});$routeProvider.when("/H1PPb1",{templateUrl:"H1PPb1",controller:"H1PPb1_Ctrl"});$routeProvider.when("/xxxxxxxxxxxxxxxx1",{templateUrl:"xxxxxxxxxxxxxxxx1",controller:"xxxxxxxxxxxxxxxx1_Ctrl"});$routeProvider.when("/H2Main",{templateUrl:"H2Main",controller:"H2Main_Ctrl"});$routeProvider.when("/H2m2",{templateUrl:"H2m2",controller:"H2m2_Ctrl"});$routeProvider.when("/H2PPb1",{templateUrl:"H2PPb1",controller:"H2PPb1_Ctrl"});$routeProvider.when("/Header2",{templateUrl:"Header2",controller:"Header2_Ctrl"});$routeProvider.when("/H2P",{templateUrl:"H2P",controller:"H2P_Ctrl"});$routeProvider.when("/xxxxxxxxxxxxxxxx2",{templateUrl:"xxxxxxxxxxxxxxxx2",controller:"xxxxxxxxxxxxxxxx2_Ctrl"});$routeProvider.when("/H3main",{templateUrl:"H3main",controller:"H3main_Ctrl"});$routeProvider.when("/H3m2",{templateUrl:"H3m2",controller:"H3m2_Ctrl"});$routeProvider.when("/xxxxxxxxxxxxxxxx3",{templateUrl:"xxxxxxxxxxxxxxxx3",controller:"xxxxxxxxxxxxxxxx3_Ctrl"});$routeProvider.when("/H4main",{templateUrl:"H4main",controller:"H4main_Ctrl"});$routeProvider.when("/H4m2",{templateUrl:"H4m2",controller:"H4m2_Ctrl"});$routeProvider.when("/xxxxxxxxxxxxxxxx4",{templateUrl:"xxxxxxxxxxxxxxxx4",controller:"xxxxxxxxxxxxxxxx4_Ctrl"});$routeProvider.when("/H5Main",{templateUrl:"H5Main",controller:"H5Main_Ctrl"});$routeProvider.when("/H5m2",{templateUrl:"H5m2",controller:"H5m2_Ctrl"});$routeProvider.when("/H5P",{templateUrl:"H5P",controller:"H5P_Ctrl"});$routeProvider.when("/HEADER-5",{templateUrl:"HEADER-5",controller:"HEADER-5_Ctrl"});$routeProvider.when("/xxxxxxxxxxxxxxxx5",{templateUrl:"xxxxxxxxxxxxxxxx5",controller:"xxxxxxxxxxxxxxxx5_Ctrl"});$routeProvider.when("/H6Main",{templateUrl:"H6Main",controller:"H6Main_Ctrl"});$routeProvider.when("/H6m2",{templateUrl:"H6m2",controller:"H6m2_Ctrl"});$routeProvider.when("/Header6",{templateUrl:"Header6",controller:"Header6_Ctrl"});$routeProvider.when("/xxxxxxxxxxxxxxxx6",{templateUrl:"xxxxxxxxxxxxxxxx6",controller:"xxxxxxxxxxxxxxxx6_Ctrl"});$routeProvider.when("/H7Main",{templateUrl:"H7Main",controller:"H7Main_Ctrl"});$routeProvider.when("/H7m2",{templateUrl:"H7m2",controller:"H7m2_Ctrl"});$routeProvider.when("/xxxxxxxxxxxxxxxx7",{templateUrl:"xxxxxxxxxxxxxxxx7",controller:"xxxxxxxxxxxxxxxx7_Ctrl"});$routeProvider.when("/H8Main",{templateUrl:"H8Main",controller:"H8Main_Ctrl"});$routeProvider.when("/H8m2",{templateUrl:"H8m2",controller:"H8m2_Ctrl"});$routeProvider.when("/xxxxxxxxxxxxxxxx8",{templateUrl:"xxxxxxxxxxxxxxxx8",controller:"xxxxxxxxxxxxxxxx8_Ctrl"});$routeProvider.when("/Rulz",{templateUrl:"Rulz",controller:"Rulz_Ctrl"});$routeProvider.when("/R1more",{templateUrl:"R1more",controller:"R1more_Ctrl"});$routeProvider.when("/R2more",{templateUrl:"R2more",controller:"R2more_Ctrl"});$routeProvider.when("/R3more",{templateUrl:"R3more",controller:"R3more_Ctrl"});$routeProvider.when("/R4more",{templateUrl:"R4more",controller:"R4more_Ctrl"});$routeProvider.when("/R5more",{templateUrl:"R5more",controller:"R5more_Ctrl"});$routeProvider.when("/R6more",{templateUrl:"R6more",controller:"R6more_Ctrl"});$routeProvider.when("/R7more",{templateUrl:"R7more",controller:"R7more_Ctrl"});$routeProvider.when("/R8more",{templateUrl:"R8more",controller:"R8more_Ctrl"});$routeProvider.when("/R9more",{templateUrl:"R9more",controller:"R9more_Ctrl"});$routeProvider.when("/R10more",{templateUrl:"R10more",controller:"R10more_Ctrl"});$routeProvider.when("/R11more",{templateUrl:"R11more",controller:"R11more_Ctrl"});$routeProvider.otherwise({redirectTo:"/Home"});}]);NeoApp.filter("checkmark",function(){return function(input){return input?"\u2713":"\u2718";};});NeoApp.filter("element",function(){return function(input,idx1,idx2){idx1=idx1||0;if(input&&input.constructor===Array){if(idx2){return input[idx1,idx2];}else{return input[idx1];};};return"";};});NeoApp.filter("string",function(){return function(input){if(input&&input.constructor===Array)return input.toString();if(input)return input;return"";};});NeoApp.filter("default",function(){return function(input,defValue){if(!input)return defValue;return input;};});NeoApp.filter("trustUrl",function($sce){return function(url){return $sce.trustAsResourceUrl(url);};});NeoApp.filter('bool',function(){return function(input,valueTrue,valueFalse){return input!==true?valueFalse:valueTrue;};});NeoApp.filter('splitLt',function(){return function(str,delimeter){var p=str.indexOf(delimeter);return(p>-1)?str.substring(0,p):str;};});NeoApp.filter('splitRt',function(){return function(str,delimeter){var p=str.indexOf(delimeter);return(p>-1)?str.substring(p+1):str;};});NeoApp.controller("NeoApp_CoreCtrl",function($scope,$rootScope,$location,$route,$modal,$window,$timeout,$interval,$http,$filter,$compile,$animate){$App=$rootScope;$App.$on("$locationChangeStart",function(event,newUrl,oldUrl){var newPg=newUrl.substr(newUrl.lastIndexOf("/")+1);var oldPg=oldUrl.substr(oldUrl.lastIndexOf("/")+1);if(newPg=="!"){event.preventDefault();};if(newPg=="Home"){$timeout($scope.Home_pageenter);};if(newPg=="H5Main"){$timeout($scope.H5Main_pageenter);};});
...
$scope.H5Main_pageenter = function() {$scope.GotoPage( "H5m2" );};
...
$App.NAB.PageID = "Home";
$scope.Headline4_click = function() {$scope.GotoPage( "H1Main" );};
$scope.Headline5_click = function() {$scope.GotoPage( "H2Main" );};
$scope.Headline6_click = function() {$scope.GotoPage( "H3main" );};
$scope.Headline7_click = function() {$scope.GotoPage( "H4main" );};
$scope.Headline8_click = function() {$scope.GotoPage( "H5Main" );};
$scope.Headline9_click = function() {$scope.GotoPage( "H6Main" );};
$scope.Headline10_click = function() {$scope.GotoPage( "H7Main" );};
$scope.Headline11_click = function() {$scope.GotoPage( "H8Main" );};
$scope.Headline78_click = function() {$scope.GotoPage( "Settings1" );};
$scope.Headline19_click = function() {$App.R1 = localStorage.getItem("R1");
...
$scope.PushButton8_click = function() {$scope.GotoPage( "H1m2" );};
...
$scope.PushButton59_click = function() {$scope.GotoPage( "HEADER1" );};
...
$App.NAB.PageID = "HEADER1";
$scope.PushButton4_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton3_click = function() {$scope.GotoPage( "H1P" );};
$scope.PushButton6_click = function() {$scope.GotoPage( "H1P" );};
});
NeoApp.controller("H1P_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 7;
$App.NAB.PageID = "H1P";
$scope.TextArea1_change = function() {localStorage.setItem("h1p",$App.h1p);};
$scope.PushButton5_click = function() {$scope.GotoPage( "Home" );};
$scope.NumericInput1_change = function() {localStorage.setItem("h1ps",$App.h1ps);};
$scope.PushButton11_click = function() {$scope.GotoPage( "H1P" );};
$scope.NumericInput3_change = function() {localStorage.setItem("h1ns",$App.h1ns);};
$scope.TextArea3_change = function() {localStorage.setItem("h1n",$App.h1n);};
$scope.PushButton20_click = function() {$scope.GotoPage( "H1PPb1" );};
});
NeoApp.controller("H1PPb1_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 8;
$App.NAB.PageID = "H1PPb1";
$scope.PushButton17_click = function() {$scope.GotoPage( "H1P" );};
$scope.TextArea7_change = function() {localStorage.setItem("h1p",$App.h1p);};
$scope.PushButton18_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea8_change = function() {localStorage.setItem("h1pb1",$App.h1pb1);};
$scope.TextArea9_change = function() {localStorage.setItem("h1pb2",$App.h1pb2);};
});
...
$scope.TextArea21_change = function() {localStorage.setItem("h2main",$App.h2main);};
$scope.PushButton10_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton16_click = function() {$scope.GotoPage( "H2m2" );};
...
$scope.PushButton61_click = function() {$scope.GotoPage( "HEADER1" );};
$scope.TextArea66_change = function() {localStorage.setItem("h2next",$App.h2next);};
$scope.TextArea68_change = function() {localStorage.setItem("h2due",$App.h2due);};
});
NeoApp.controller("H2PPb1_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 12;
$App.NAB.PageID = "H2PPb1";
$scope.PushButton19_click = function() {$scope.GotoPage( "H1P" );};
$scope.TextArea10_change = function() {localStorage.setItem("h2p",$App.h2p);};
$scope.PushButton21_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea11_change = function() {localStorage.setItem("h2pb1",$App.h2pb1);};
$scope.TextArea12_change = function() {localStorage.setItem("h2pb2",$App.h2pb2);};
});
NeoApp.controller("Header2_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 13;
$App.NAB.PageID = "Header2";
$scope.PushButton7_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton9_click = function() {$scope.GotoPage( "H2P" );};
$scope.PushButton14_click = function() {$scope.GotoPage( "H2P" );};
});
NeoApp.controller("H2P_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 14;
$App.NAB.PageID = "H2P";
$scope.TextArea2_change = function() {localStorage.setItem("h1p",$App.h1p);};
$scope.PushButton12_click = function() {$scope.GotoPage( "Home" );};
$scope.NumericInput2_change = function() {localStorage.setItem("h2ps",$App.h2ps);};
$scope.PushButton13_click = function() {$scope.GotoPage( "H2P" );};
$scope.NumericInput4_change = function() {localStorage.setItem("h2ns",$App.h2ns);};
$scope.TextArea4_change = function() {localStorage.setItem("h2n",$App.h2n);};
$scope.PushButton15_click = function() {$scope.GotoPage( "H2PPb1" );};
});
...
$scope.PushButton29_click = function() {$scope.GotoPage( "H3m2" );};
...
$scope.PushButton63_click = function() {$scope.GotoPage( "HEADER1" );};
$scope.TextArea69_change = function() {localStorage.setItem("h3next",$App.h3next);};
$scope.TextArea70_change = function() {localStorage.setItem("h3due",$App.h3due);};
});
...
$scope.PushButton65_click = function() {$scope.GotoPage( "HEADER1" );};
$scope.TextArea71_change = function() {localStorage.setItem("h4next",$App.h4next);};
$scope.TextArea72_change = function() {localStorage.setItem("h4due",$App.h4due);};
});
...
$scope.TextArea22_change = function() {localStorage.setItem("h5main",$App.h5main);};
$scope.PushButton28_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton34_click = function() {$scope.GotoPage( "H5m2" );};
...
$scope.PushButton67_click = function() {$scope.GotoPage( "HEADER1" );};
$scope.TextArea73_change = function() {localStorage.setItem("h5next",$App.h5next);};
$scope.TextArea74_change = function() {localStorage.setItem("h5due",$App.h5due);};
});
NeoApp.controller("H5P_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 24;
$App.NAB.PageID = "H5P";
$scope.PushButton25_click = function() {$scope.GotoPage( "H5P" );};
$scope.TextArea15_change = function() {localStorage.setItem("h5p",$App.h5p);};
$scope.PushButton26_click = function() {$scope.GotoPage( "Home" );};
$scope.NumericInput5_change = function() {localStorage.setItem("h5ps",$App.h5ps);};
$scope.PushButton27_click = function() {$scope.GotoPage( "H5N" );};
$scope.NumericInput6_change = function() {localStorage.setItem("h5ns",$App.h5ns);};
$scope.TextArea16_change = function() {localStorage.setItem("h5n",$App.h5n);};
});
NeoApp.controller("HEADER-5_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 25;
$App.NAB.PageID = "HEADER-5";
...
$scope.PushButton38_click = function() {$scope.GotoPage( "H6m2" );};
...
$scope.PushButton69_click = function() {$scope.GotoPage( "HEADER1" );};
$scope.TextArea75_change = function() {localStorage.setItem("h6next",$App.h6next);};
$scope.TextArea76_change = function() {localStorage.setItem("h6due",$App.h6due);};
});
NeoApp.controller("Header6_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 29;
$App.NAB.PageID = "Header6";
$scope.PushButton24_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea17_change = function() {localStorage.setItem("h6p",$App.h6p);};
$scope.TextArea19_change = function() {localStorage.setItem("h6n",$App.h6n);};
$scope.PushButton32_click = function() {$App.voice = "UK";
$App.a = localStorage.getItem("a");
$App.b = localStorage.getItem("b");
neoTalkSpeak($App.h6p, "uk", 1, .9);};
$scope.PushButton33_click = function() {$App.voice = "UK";
$App.a = localStorage.getItem("a");
$App.b = localStorage.getItem("b");
neoTalkSpeak($App.h6n, "uk", 1, .9);};
});
...
$scope.PushButton40_click = function() {$scope.GotoPage( "H7m2" );};
...
$scope.PushButton71_click = function() {$scope.GotoPage( "HEADER1" );};
$scope.TextArea77_change = function() {localStorage.setItem("h7next",$App.h7next);};
$scope.TextArea78_change = function() {localStorage.setItem("h7due",$App.h7due);};
});
...
$scope.PushButton42_click = function() {$scope.GotoPage( "H8m2" );};
...
$App.NAB.PageID = "H8m2";
$scope.PushButton72_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton73_click = function() {$scope.GotoPage( "HEADER1" );};
