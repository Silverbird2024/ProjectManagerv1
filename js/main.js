...
$scope.HomeM_pageenter = function() {$App.h1 = localStorage.getItem("h1");
$App.h2 = localStorage.getItem("h2");
$App.h3 = localStorage.getItem("h3");
$App.h4 = localStorage.getItem("h4");
$App.h5 = localStorage.getItem("h5");
...
NeoApp.controller("HomeM_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 2;
$App.NAB.PageID = "HomeM";
...
$scope.PushButton72_click = function() {$scope.GotoPage( "Test2" );};
});
