...
$scope.Prayer1_pageexit = function() {localStorage.setItem("Prayer1mainR",$App.Prayer1main);};
...
$App.NAB.PageID = "q11";
$scope.TextArea204_change = function() {localStorage.setItem("q8",$App.Q8);};
